<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageuser.master" AutoEventWireup="true" CodeFile="userprofile.aspx.cs" Inherits="_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <h2>
        Welcome to User Profile</h2>
    <p>
            ...
            <tr>
                ...
                <td class="style3">
                    <asp:Button ID="Button1" runat="server" ForeColor="#33CCFF" 
                        onclick="Button1_Click1" Text="UPDATE" />
                </td>
            </tr>
            <tr>
                <td class="style2">
